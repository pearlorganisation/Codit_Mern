...
const Footer = () => {
  ...
  return (
    <footer className="  px-4 py-5 text-white  mx-auto md:px-8 bg-[#3D3B40]">
            <div className="gap-6 justify-between md:flex">
                ...
                <div className="flex-1 mt-10 space-y-6 p-10 items-center justify-between sm:flex md:space-y-0 md:mt-0">
                    {
            ...
            <div className="mt-8 py-6 border-t items-center justify-between sm:flex">
                <div className="mt-4 sm:mt-0">
                    &copy; 2024 Rabis's All rights reserved.
                </div>
