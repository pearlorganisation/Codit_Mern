...
export default function Header() {
    ...
    return (
        <header className="text-base lg:text-sm">
            <div
                className={`bg-white items-center gap-x-14 px-4 max-w-screen-xl mx-auto lg:flex lg:px-8 lg:static ${state ? 'h-full fixed inset-x-0' : ''
                    }`}
            >
                <div className="flex items-center justify-between py-3 lg:py-5 lg:block">
                    ...
                    <div className="flex items-center lg:hidden gap-4">
                        <form onSubmit={(e) => e.preventDefault()} className={`${state ? 'hidden' : 'flex items-center'
                    }`}>
                            <div className="flex items-center gap-1 px-2 w-full border rounded-lg">
                                <svg
                        ...
                        {/* Heart, Bag and Search Icons */}
                        <a href="/" className="block text-gray-700 hover:text-gray-900">
                            <PiBagLight size={28} color="#B13481" />
                        </a>
                        <a href="/" className="block text-gray-700 hover:text-gray-900">
                            <GoHeart size={25} color="#B13481" />
                        </a>
                        <button
                ...
                >
                    <ul className="items-center space-y-6 lg:flex lg:space-x-6 lg:space-y-0">
                       ...
                       { state ? "":<><a href="/" className="block text-gray-700 hover:text-gray-900">
                            <PiBagLight size={28} color="#B13481" />
                        </a>
                        <a href="/" className="block text-gray-700 hover:text-gray-900">
                            <GoHeart size={25} color="#B13481" />
            ...
            <nav className="border poppins-semibold">
                <ul className="hidden lg:flex justify-center items-center gap-x-3 max-w-screen-xl mx-auto px-4 overflow-x-auto lg:px-8">
                    {submenuNav.map((item, idx) => {
                        return (
                            <NavLink
                                key={idx}
