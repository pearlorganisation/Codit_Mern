  ...
  return (
    <div className="bg-gray-100 ">
      <div className=" bg-white rounded-lg shadow-lg overflow-hidden p-2 ">
        ...
        <div className="p-4">
          <h3 className="text-xl md:text-2xl text-center mb-2 gupter-medium poppins-semibold text-[#484848]">
            {data?.title}
          </h3>
