  ...
  return (
    <div className=" space-y-8">
          ...
          extrasCollection.map((el,index)=>{
            return(<div key={index} className='relative' >
               ...
               <span className='absolute top-40 left-20 right-20 text-white'>
                ...
                <a href="/" className='underline text-center font-semibold hover:no-underline '><p className='text-center'>Shop Now</p></a>
               </span>
            </div>);
          })
        }
      ...
      <div className='space-y-4'>
        ...
        <h1 className="uppercase text-3xl  font-bold text-[#5F6C72] text-left ">Trending in indian wear</h1>
        <div className="grid grid-cols-2 gap-4 px-4   justify-center items-center">

          {
            TrendingHomeWear.map((el, index) => {
              return (
                <div key={index} className="flex flex-col p-5 justify-center items-center    gap-8" style={{ boxShadow: " rgba(100, 100, 111, 0.2) 0px 7px 29px 0px" }}>
                  <div>
      ...
      <div className='grid space-y-4'>
        <h1 className="text-[#3D3B40] text-semibold uppercase text-4xl">SEASONS COLLECTION</h1>
        <div className="grid grid-cols-4 justify-center items-center gap-6">
          {
            seasonCollection.map((el, index) => {
              return (<div key={index} className="flex flex-col gap-5 justify-center items-center p-5 rounded-md" style={{ boxShadow: "rgba(100, 100, 111, 0.2) 0px 7px 29px 0px" }} >
