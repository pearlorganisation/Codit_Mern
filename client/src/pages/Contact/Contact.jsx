  ...
  return (
    <div>
      <div className="grid grid-cols-1 lg:grid-cols-[40%_auto] gap-8 p-16 poppins-semibold">
        <div
          className="border border-pink-400 bg-[#FFFFFF] p-5 md:p-10 rounded-lg"
        ...
        <div
          className="w-full border p-8 bg-[#FFFFFF] border-pink-500 rounded-lg"
          style={{ boxShadow: "rgba(100, 100, 111, 0.2) 0px 7px 29px 0px" }}
        >
            ...
            <div>
              ...
              <input
                {...register("firstName", {
                  ...
                  minLength: {
                    value: 3,
                    message: "Min Length for first name is 3",
                  },
                  maxLength: {
                    value: 25,
                    message: "Max Length for first name is 25",
                  },
                })}
            ...
            <div>
              ...
              <input
                {...register("lastName", {
                  ...
                  minLength: {
                    value: 3,
                    message: "Min Length for last name is 3",
                  },
                  maxLength: {
                    value: 25,
                    message: "Max Length for last name is 25",
                  },
                })}
                className="w-full mt-2 px-3 py-2 text-gray-500 bg-transparent outline-none border focus:border-pink-600 shadow-sm rounded-lg"
              />
            ...
            <div>
              ...
              <input
                {...register("phoneNumber", {
                  ...
                  maxLength: {
                    value: 30,
                    message: "Phone number cannot be more than 30 digits",
                  },
                })}
