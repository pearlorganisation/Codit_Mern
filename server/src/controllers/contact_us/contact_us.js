...
export const createContact = asyncHandler(async (req, res) => {
    ...
    res
      .status(200)
      .json({ success: true, message: "Contact Created Successfully !! ",data:contactUs });
  });
export const updateContact = asyncHandler(async (req, res) => {
    ...
    res
      .status(200)
      .json({ success: true, message: "Contact Updated Successfully !! ",data:Contact });
  });
...
export const getContact = asyncHandler(async (req, res) => {
    ...
    res
      .status(200)
      .json({ success: true, message: "Contact Found Successfully!! ",data:contact });
  });
